...
const NkStickyFieldsetTable = props => {
                ...
                <Div style={NwClass.nk_modal_body}>
                    <Div style={[NwClass.row, NwClass.margin_y_10]}>
                        <Div style={[NwClass.col, NwClass.col_12, NwClass.col_parent]}>
                            <Div style={[NwClass.row, { justifyContent: 'space-between' }]}>
                                <Div style={[NwClass.col, NwClass.col_5, NwClass.inlineBlockBtn, NwClass.position_x_left, { width: '80%' }]}>
                                    <NkButton
                                        buttonTitle
                                        title={
                                    ...
                                    <NkButton
                                        ...
                                        title={
                                            <View style={styles.iconContainer}>
                                                <Image style={NwClass.fieldsetTableIcon} source={require('../assets/demoIcons/grid-icon-design/hide-report-header-icon-design-22x22p-v2.png')} />
                                            </View>
                                        }
                                        style={styles.icon}
                                    />
                                    <NkButton
                                        ...
                                        title={
                                            <View style={styles.iconContainer}>
                                                <Image style={NwClass.fieldsetTableIcon} source={require('../assets/demoIcons/grid-icon-design/download-upload-template-design-22x22p.png')} />
                                            </View>
                                        }
                                        style={styles.icon}
                                    />
                                    <NkButton
                                        ...
                                        title={
                                            <View style={styles.iconContainer}>
                                                <Image style={NwClass.fieldsetTableIcon} source={require('../assets/demoIcons/grid-icon-design/reverse-icon-design-22x22p.png')} />
                                            </View>
                                        }
                                        style={styles.icon}
                                    />
                                    <NkButton
                                        ...
                                        title={
                                            <View style={styles.iconContainer}>
                                                <Image style={NwClass.fieldsetTableIcon} source={require('../assets/demoIcons/grid-icon-design/copy-row-icon-design-22x22p-v2.png')} />
                                            </View>
                                        }
                                        style={styles.icon}
                                    />
                                    <NkButton
                                        ...
                                        title={
                                            <View style={styles.iconContainer}>
                                                <Image style={NwClass.fieldsetTableIcon} source={require('../assets/demoIcons/grid-icon-design/load-fvh-template-icon-design-22x22p.png')} />
                                            </View>
                                        }
                                        style={styles.icon}
                                    />
                                    <NkButton
                                        ...
                                        title={
                                            <View style={styles.iconContainer}>
                                                <Image style={NwClass.fieldsetTableIcon} source={require('../assets/demoIcons/grid-icon-design/prepayment-icon-design-22x22p.png')} />
                                            </View>
                                        }
                                        style={styles.icon}
                                    />
                                    ...
                                    <NkButton
                                        ...
                                        title={
                                            <View style={styles.iconContainer}>
                                                <Image style={NwClass.fieldsetTableIcon} source={require('../assets/demoIcons/grid-icon-design/close-ticket-icon-design-22x22p.png')} />
                                            </View>
                                        }
                                        style={styles.icon}
                                    />
                                    <NkButton
                                        ...
                                        title={
                                            <View style={styles.iconContainer}>
                                                <Image style={NwClass.fieldsetTableIcon} source={require('../assets/demoIcons/grid-icon-design/open-ticket-icon-design-22x22p.png')} />
                                            </View>
                                        }
                                        style={styles.icon}
                                    />
                                    <NkButton
                                        ...
                                        title={
                                            <View style={styles.iconContainer}>
                                                <Image style={NwClass.fieldsetTableIcon} source={require('../assets/demoIcons/grid-icon-design/takeover-ticket-icon-design-22x22p.png')} />
                                            </View>
                                        }
                                        style={styles.icon}
                                    />
                                    <NkButton
                                        ...
                                        title={
                                            <View style={styles.iconContainer}>
                                                <Image style={NwClass.fieldsetTableIcon} source={require('../assets/demoIcons/grid-icon-design/clear-fields-icon-design-22x22p.png')} />
                                            </View>
                                        }
                                        style={styles.icon}
                                    />
                                    {/* <Div style={[NwClass.col, NwClass.col_7, { width: '25%' }]}>
                                        <NkSearchBar
                                ...
                                <Div style={[NwClass.col, NwClass.col_7, { width: '20%' }]}>
                                    <NkSearchBar
                                        style={[NwClass.txtbox, { height: 42, paddingVertical: 0, }]}
                                        placeholder='Filter'
                                    // textStyle={NwClass.nk_SelectText}
...
export default NkStickyFieldsetTable
